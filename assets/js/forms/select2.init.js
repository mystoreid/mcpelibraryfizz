...
//
// Support Version access
//
var $select = $(".js-support-version").select2();
var $selectMulti = $(".js-support-version-multiple").select2();
$selectMulti.select2({
  placeholder: "Select Versions",
});
$(".js-support-version-set-val").on("click", function () {
  $select.val("NM").trigger("change");
});

$(".js-support-version-open").on("click", function () {
  $select.select2("open");
});
$(".js-support-version-close").on("click", function () {
  $select.select2("close");
});

$(".js-support-version-init").on("click", function () {
  $select.select2();
});
$(".js-support-version-destroy").on("click", function () {
  $select.select2("destroy");
});

$(".js-support-version-multi-set-val").on("click", function () {
  $selectMulti.val(["UT", "NM"]).trigger("change");
});
$(".js-support-version-multi-clear").on("click", function () {
  $selectMulti.val(null).trigger("change");
});
